        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4>{{ $stats['active_reservations'] ?? 0 }}</h4>
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="{{ route('admin.books') }}" class="list-group-item list-group-item-action">
                            ...
                            <small class="text-muted float-end">{{ $stats['total_books'] ?? 0 }} libri</small>
                        </a>
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="{{ route('admin.reservations') }}" class="list-group-item list-group-item-action">
                            ...
                            <small class="text-muted float-end">{{ $stats['active_reservations'] ?? 0 }} attive</small>
                        </a>
                        <a href="{{ route('admin.users') }}" class="list-group-item list-group-item-action">
                            <i class="fas fa-users"></i> Utenti Registrati
                            <small class="text-muted float-end">{{ $stats['total_users'] ?? 0 }} utenti</small>
                        </a>
                    </div>
                </div>
            </div>
