                                    ...
                                    <td>
                                        @if($book->cover_image)
                                            @if(Str::startsWith($book->cover_image, ['http://', 'https://']))
                                                {{-- Link esterno (Factory) --}}
                                                <img src="{{ $book->cover_image }}" alt="Copertina" style="width: 40px; height: 50px; object-fit: cover; border-radius: 4px;">
                                            @else
                                                {{-- File locale caricato a mano --}}
                                                <img src="{{ asset('storage/' . $book->cover_image) }}" alt="Copertina" style="width: 40px; height: 50px; object-fit: cover; border-radius: 4px;">
                                            @endif
                                        @else
                                            <div class="bg-light d-flex align-items-center justify-content-center" style="width: 40px; height: 50px; border-radius: 4px;">
