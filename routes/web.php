...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/my-reservations', [BookController::class, 'myReservations'])->name('books.my-reservations');
    Route::delete('/reservations/{reservation}/cancel', [BookController::class, 'cancelReservation'])->name('books.reservations.cancel');
});
